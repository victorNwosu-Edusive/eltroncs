      ...
      <header className="relative overflow-hidden">
        ...
        >
          ...
          <section className="relative p-10 pb-11 md:p-20 lg:p-20 bg-[#fffefe] items-center">
            <div className="flex justify-between"><h1 className="font-bold text-slate-600 text-xl md:text-2xl lg:text-2xl lg:text-center mb-7">Bestsellers</h1> <NavLink className="flex justify-center items-center gap-2 text-slate-500 text-sm hover:underline duration-300">See more <ChevronRight size={13} /></NavLink></div>
